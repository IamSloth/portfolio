...
async function finalSubmissionV3() {
    console.log("🚀 Launching Chrome for V3 Submission (Photo Fixed)...");
    ...
    try {
        ...
        const resumePath = path.resolve(__dirname, '../output/Lim_JongKwon_ShiftUp_Resume_Design_v3.pdf');
        ...
        console.log("\n✅ ALL DONE. Please verify the photo in PDF and Submit.");
