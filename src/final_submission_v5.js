...
async function finalSubmissionV5() {
    console.log("🚀 Launching Chrome for V5 Submission (Layout Fixed)...");
    ...
    try {
        ...
        const resumePath = path.resolve(__dirname, '../output/Lim_JongKwon_ShiftUp_Resume_Final_V5.pdf');
