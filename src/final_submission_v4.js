...
async function finalSubmissionV4() {
    console.log("🚀 Launching Chrome for V4 Submission (User Photo)...");
    ...
    try {
        ...
        const resumePath = path.resolve(__dirname, '../output/Lim_JongKwon_ShiftUp_Resume_Final.pdf');
