...
async function finalApplyWithDesign() {
    console.log("🚀 Launching Clean Browser for Final Submission...");
    ...
    // NEW DESIGN RESUME PATH
    const resumePath = path.resolve(__dirname, '../output/Lim_JongKwon_ShiftUp_Resume_Design_v1.pdf');
    ...
    console.log("\n✅ READY TO SUBMIT. Good Luck, Mr. Lim!");
}

finalApplyWithDesign();
