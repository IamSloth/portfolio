...
async function finalSubmissionV6() {
    console.log("🚀 Launching Chrome for V6 Submission (Official Style)...");
    ...
    try {
        ...
        const resumePath = path.resolve(__dirname, '../output/Lim_JongKwon_ShiftUp_Resume_Final_V6.pdf');
