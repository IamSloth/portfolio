...
| 16 | 이크래더블 (아이위더스 파견) | TCB 보고서 작성 | **📞 INTERVIEW** | 1차면접 3/13 완료 (5분), 결과 대기 | `16_ecredible/tcb_report/` |
...
- **Application folders**: Numbered by discovery date: `{NN}_{company}/`. Next new company = `20_`.
